...
{
    public class QuotesResponseModel: CompanyResponseModel
    {
        public CompanyResponseModel GetCompanyLookUpList()
        {
            CompanyResponseModel lookUpList = new CompanyResponseModel
            {
                Name = this.Name,
                Symbol = this.Symbol,
